...
\QuaternaryInfC{$\Gamma \vdash e_1 \ op \ e_2 : T $}
\end{prooftree}
...
\AxiomC{$T \in dom$ op}
\AxiomC{$T' \in codom$ op}
\TrinaryInfC{$\Gamma \vdash op \ e : T' $}
\end{prooftree}
...
\AxiomC{$\Gamma \vdash e_2 : T_2 $}
\AxiomC{$\ldots$}
\AxiomC{$\Gamma \vdash e_n : T_n $}
\QuaternaryInfC{$\Gamma \vdash (e_1,e_2,\ldots,e_n) : T_1 \times T_2 \times \ldots \times T_n)$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\Gamma \vdash e_1 : T_2 $}
\AxiomC{$\Gamma \vdash e_2 : T_1 \rightarrow T_2 $}
\AxiomC{$\Gamma \vdash e_3 : T_1 $}
\TrinaryInfC{$\Gamma \vdash e_1 = e_2 (e_3) : T_2 $}
\end{prooftree}

\tabto{0cm} {\large \textbf{Function Call without return}}
\begin{prooftree}
\AxiomC{$\Gamma \vdash e_1 : T_1 \rightarrow void$}
\AxiomC{$\Gamma \vdash e_2 : T_1 $}
\BinaryInfC{$\Gamma \vdash e_1(e_2) : void $}
\end{prooftree}
...
\AxiomC{$\Gamma \vdash e_1 : bool$}
\AxiomC{$\Gamma \vdash e_2 : T $}
\BinaryInfC{$\Gamma \vdash while(e_1) \ \{ e_2 \} : T $}
\end{prooftree}

\tabto{0cm} {\large \textbf{Return void}}
\begin{prooftree}
\AxiomC{$ $}
\UnaryInfC{$\Gamma \vdash return : void $}
\end{prooftree}

\tabto{0cm} {\large \textbf{Return Expression }}
\begin{prooftree}
\AxiomC{$\Gamma \vdash e : T$}
\UnaryInfC{$\Gamma \vdash return \ e : T $}
\end{prooftree}
